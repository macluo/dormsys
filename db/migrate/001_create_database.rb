#
# This file is created to assist database migration from ground zero
# If possible, please use rake db:structure:load to construct the SQL database from structure.sql
# instead of rake db:migrate
# All foreign key constraints are at DBMS layer, applications layer are not enforced in this project
#
